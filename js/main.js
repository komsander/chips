...
sr.reveal('.home__circle, .home__img',{delay:1000, scale:.5})
sr.reveal('.home__chips-1, .home__chips-2, .home__chips-3',{delay:1000, scale:.5})
sr.reveal('.home__leaf',{delay:1200, scale:.5})
